                ...
                <form action="UserController" method="post" class="login" name="edit_form" enctype="multipart/form-data">
                    ...
                    <img src="${pageContext.request.contextPath}/assets/img/profileIconYellow.gif">
                     ...
                     <div class="input_wrapper">
                        ...
                        <input type="text" name="course_code" id="course_code" value="${userProfile.course_code}"/>
                    </div>
                    
                    <div class="input_wrapper">
                        <img src="${pageContext.request.contextPath}/assets/img/profileIconYellow.gif">
                        <input type="text" name="k_number" id="k_number" value="${userProfile.k_number}"/>
                    </div>
                    ...
                    <div class="input_wrapper">
                        <img src="${pageContext.request.contextPath}/assets/img/emailIconYellow.gif">
                        <input type="text" name="contact_number" id="contact_number" value="${userProfile.contact_number}"/>
                    </div>
                    <div class="input_wrapper">
                        <img src="${pageContext.request.contextPath}/assets/img/profileIconYellow.gif">
                    ...
                    <div class="input_wrapper">
                        ...
                        <input type="password" name="password" id="password" value="${userProfile.password}"/>
                    </div>
                    <div class="input_wrapper">
                        <img src="${pageContext.request.contextPath}/assets/img/collegeIconYellow.gif">
                        <input type="text" name="course_year" id="course_year" value="${userProfile.course_year}"/>
                    </div>
                    <div class="input_wrapper">
                        <img src="${pageContext.request.contextPath}/assets/img/profileIconYellow.gif">
                        <textarea name="profile_description" id="profile_description" rows="10" columns="55">${userProfile.profile_description}</textarea>
                    </div>
                    <input type="submit" name="menu" value="SaveUserDetailsAdmin" />
                </form>
            </div>
          </div>
