                    ...
                    <a href="${pageContext.request.contextPath}/ShowController?menu=Drilldown&show_id=${show.show_id}" class="thumbnail_link">
                        <div class="thumbnail">
                            <c:forEach var="project" items="${showProjects}">
                                <c:if test="${project.show_id == show.show_id}">
                                    <div class="show_project_link">
                                    <div class="image_wrapper">
                                        <img class="project_image" src="${pageContext.request.contextPath}/assets/img/projectImages/${project.project_image}" alt="project image">
                                    </div>
