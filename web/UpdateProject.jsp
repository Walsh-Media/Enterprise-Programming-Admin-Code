<%-- 
    ...
    Created on : 30-Jan-2020, 11:45:33
    Author     : Owner
--%>
...
<html>
    ...
    <body>
        ...
        <form action="ProjectController" method="get" class="project_form" name="project_form">
            ...
            <textarea name="project_body" id="project_body" rows="10" columns="55">${project.project_body}</textarea>
            <label for="project_image">Project image</label>
            <input type="text" name="project_image" value="${project.project_image}"/>
            <label for="video_link">Video link</label>
            <input type="text" name="video_link" velue="${project.video_link}"/>
            <label for="project_price">Project price</label>
            <input type="text" name="project_price" value="${project.project_price}"/>
