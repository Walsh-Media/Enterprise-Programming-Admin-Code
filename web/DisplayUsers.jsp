        ...
        <div class="container">
            <div class="profiles">
                <c:forEach var="user" items="${allUsers}">
                    <a href="${pageContext.request.contextPath}/UserController?menu=userProfile&user_id=${user.user_id}" class="thumbnail_link">
                        <div class="thumbnail profiles_link">
                            <div class="image_wrapper">
                                <img class="profile_image" src="${pageContext.request.contextPath}/assets/img/profileImages/${user.profile_image}" alt="profile image">
                            </div>
                            
                            <h2 class="project_name">${user.full_name}</h2>
                            <p>Email: ${user.email}</p>
                            <p>Course: ${user.course_code}</p>
